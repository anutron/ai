...
| [claude-md-management](../skills/claude-md-management/SKILL.md) | Reference for editing CLAUDE.md content – snippet locations, naming convention, template variables, and compile.sh commands (compile/promote/demote/list/status). Load when the user wants to add, edit, or reorganize CLAUDE.md rules, or move a rule between global and project scope. |
